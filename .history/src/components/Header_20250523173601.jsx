...
const Header = () => {
  ...
  const handleLogout = () => {
    Swal.fire({
      ...
      icon: 'question',
      iconColor: '#e53e3e',
      showCancelButton: true,confirmButtonText: '<span style="font-weight: 600; color: #d33;">نعم، تسجيل الخروج</span>',
cancelButtonText: '<span style="font-weight: 600; color: #3085d6;">إلغاء</span>',
