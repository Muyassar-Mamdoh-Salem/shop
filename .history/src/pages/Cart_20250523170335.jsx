...
const Cart = () => {
  ...
  return (
    <div className="mt-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
     ...
     <link to="/checkout"><button className="bg-yellow-500  text-white py-3 px-6 rounded-full shadow-xl hover:bg-yellow-600 transition">Proceed to Checkout</button></link> 
      </div>
    </div>
  );
};
