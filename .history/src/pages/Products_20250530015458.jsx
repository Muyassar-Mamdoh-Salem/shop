  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      ...
      {filteredProducts.length > 0 ? (
            ...
            >
              <button
                ...
                className={`absolute top-3 right-3 bg-white rounded-full p-1 shadow-md transition-all duration-300
                  ${favorites.some(item => item.id === product.id) ? 'text-red-500' : 'text-gray-400'}
              ...
              <img src={product.image} alt={product.title} className="h-40 object-contain mb-4 mx-auto" loading="lazy" />
        ...
        <p className="text-center text-gray-500 text-lg mt-8">No matching products found.</p>
      )}
    </div>
  );
};
