          ...
          return (
            ...
            >
              ...
              <div className="text-white text-center sm:text-right w-full sm:w-1/3">
                ...
                <button className='mt-3 text-sm text-white border border-white rounded-lg px-2 py-1 hover:bg-white hover:text-gray-400 transition' onClick={()=> dispatch(RemoveOneCart({id:product.id}))}>clear product</button>
              </div>
            </div>
          );
        })}
